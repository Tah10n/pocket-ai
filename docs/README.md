...
- [`runtime-hardening-device-validation.md`](./runtime-hardening-device-validation.md): physical-device model/backend matrix, prompt state-cache A/B protocol, and honest evidence template
