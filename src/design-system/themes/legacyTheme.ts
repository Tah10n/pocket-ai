...
function createLegacyThemeColors(mode: ResolvedThemeMode, useGlassOverrides: boolean): ThemeColors {
  ...
  return {
    ...
    surface: isDark ? withAlpha(background[0], 0.12) : withAlpha(background[50], 0.3),
    surfaceMuted: isDark ? withAlpha(background[0], 0.1) : withAlpha(background[50], 0.24),
    surfaceElevated: isDark ? withAlpha(background[0], 0.15) : withAlpha(background[50], 0.34),
    ...
    divider: 'transparent',
    inputBackground: isDark ? withAlpha(background[0], 0.12) : withAlpha(background[50], 0.26),
    cardBackground: isDark ? withAlpha(background[0], 0.14) : withAlpha(background[50], 0.3),
