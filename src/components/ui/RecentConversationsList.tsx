    ...
    <View className="px-4 mt-8 pb-4">
      ...
      <View className="gap-3">
        {mockConversations.map((conv) => (
          <Pressable 
            key={conv.id} 
            className="flex-row items-center p-4 rounded-xl bg-white dark:bg-primary/5 border border-slate-200 dark:border-primary/10 transition-colors active:opacity-70"
          >
