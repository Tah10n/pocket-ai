...
export function getThemeColors(mode: ResolvedThemeMode): ThemeColors {
  ...
  return {
    ...
    surface: isDark ? withAlpha(background[900], 0.92) : background[50],
    surfaceMuted: isDark ? withAlpha(background[800], 0.88) : background[100],
    surfaceElevated: isDark ? withAlpha(background[800], 0.96) : background[0],
    ...
    borderSubtle: withAlpha(isDark ? outline[700] : outline[200], isDark ? 0.55 : 0.8),
    ...
    inputBackground: isDark ? withAlpha(background[900], 0.86) : background[50],
    cardBackground: isDark ? withAlpha(background[900], 0.82) : background[50],
    overlay: withAlpha(background[950], isDark ? 0.72 : 0.32),
    tabBarBackground: isDark ? withAlpha(background[950], 0.96) : withAlpha(background[0], 0.96),
    tabBarBorder: isDark ? withAlpha(outline[700], 0.7) : withAlpha(outline[200], 0.9),
    tabBarActive: isDark ? primary[300] : primary[600],
    tabBarInactive: isDark ? typography[400] : typography[500],
